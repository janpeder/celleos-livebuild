...
\hbox to \tocwidth{4.2 Root-tilgang i Terminal \dotfill 9}
\hbox to \tocwidth{4.3 Midlertidig godkjenne en USB-enhet \dotfill 9}
\hbox to \tocwidth{4.4 Permanent godkjenne en USB-enhet \dotfill 9}
\hbox to \tocwidth{4.5 Midlertidig deaktivere brannmur \dotfill 9}
...
\item{5.} N\aa r programmet er ferdig skriver du ``{\tt exit}'' for \aa{} logge ut root-brukeren.
