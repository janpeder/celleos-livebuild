...
\vskip 4pt
\item{2.} Avbildingsfilen er stor og nedlastingen kan derfor ta en stund. N\aa r den er ferdig nedlastet skal du laste ned og installerere programmet {\it Rufus}. Rufus finner du p\aa{} nettadressen under. 
\smallskip
{\tt https://rufus.ie/}
\imagewithcaption{6cm}{bilder/rufus-nedlastning.eps}{For \aa{} finne lenken du skal trykke p\aa{} m\aa{} du rulle nedover p\aa{} nettsiden.}
\item{3.} Koble minnepennen du vil bruke til PCens USB-kontakt. {\it (Husk at alt p\aa{} minnepennen vil bli overskrevet.)}
\item{4.} \AA pne Rufus, som du nettopp lastet ned. Det vil da åpnes et vindu som ser ut som p\aa{} bildet under.
%\imagewithcaption{8cm}{vcxvxcv
...
\item{2.} Du skal n\aa{} starte opp datamaskina og holde inne en bestemt tast. Hvilken tast du skal holde inne varierer avhengig av produsent. Det kommer vanligvis opp p\aa{} skjermen rett etter at datamaskinen startes, for eksempel kan det st\aa{} ``Press F2 to enter Setup''. De vanligste tastene er enten {\it F1}, {\it F2}, {\it F10}, {\it ENTER} eller {\it DEL}.
...
\smallskip
\noindent N\aa r du har utf\o rt alle stegene i lista over skal installasjonsprogrammet for Celleos startes automatisk n\aa r minnepennen st\aa r i PCen og maskinen skrus p\aa.


\beginsection {\fss 2.4. Installasjon}

\item{1.} N\aa r du setter installasjonsminnepennen (som du lagde i delkapittel 2.1) i datamaskinen og skrur p\aa{} vil du se en advarsel. Hvis du ikke f\aa r opp denne advarselen n\aa r du skrur p\aa{} maskinen er det mulig du har gjort noe galt da du konfigurerte datamaskinen for oppstart fra USB (delkapittel 2.3). 
\medskip
...
\vfill\eject
\topglue 1pc
\beginsection {\fs 2.5. Sikring av datamaskin etter installasjon}

Celleos beskytter mot de fleste sikkerhetstruslene som er beskrevet i delkapittel 1.4, men noen av 
