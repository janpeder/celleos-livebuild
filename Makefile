...
rawfilesinstall/etc/skel/.config/dconf/user: dconfsettings.d/enabledextensions dconfsettings.d/desktopbackgroundsettings dconfsettings.d/favoriteappssettings
